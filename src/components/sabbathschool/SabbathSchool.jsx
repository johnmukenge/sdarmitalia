...
import { leggiTesto } from "../../utils/speech"; // Importa la lettura vocale
import { BsFillVolumeUpFill, BsFillVolumeMuteFill, BsMoonStarsFill, BsSunFill } from "react-icons/bs"; // Icone
import lezioni from "../../data/lezioni.js"; // Dati delle lezioni

const SabbathSchool = () => {
  const [selectedWeek, setSelectedWeek] = useState(0);
  const [darkMode, setDarkMode] = useState(false); // Dark mode locale
  const [isSpeaking, setIsSpeaking] = useState(false);
  const lessonRef = useRef(null);

  // Funzione per selezionare una settimana e scrollare alla sezione
